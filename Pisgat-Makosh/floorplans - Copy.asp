	...
	<section id="page-content">
		...
		<div class="page-content-tab tab1 ontop">
			<ul id="floorplans-filter">
				...
				<li class="filter-item" data-filter="5-bedrooms"><a href="#">דירת 5 חדרים</a></li>
				<li class="filter-item" data-filter="garden"><a href="#">דירת גן</a></li>
			...
			<ul id="gallery" class="gallery grid effect-2">
				...
				<li class="green mix mini-penthouse">
					<a href="floorplans/plan01.pdf" target="_blank" title="">
						<img src="floorplans/plan01.jpg" />
						<div></div>
					</a>
					<span>מיני פנטהאוז<br />3 חדרים</span>
				</li>
				<!--
				...
				<li class="yellow mix garden">
					<a href="floorplans/plan02.pdf" target="_blank" title="">
				...
				<li class="orange mix 3-bedrooms">
					<a href="floorplans/plan03.pdf" target="_blank" title="">
				...
				<li class="fuchsia mix 5-bedrooms">
					<a href="floorplans/plan04.pdf" target="_blank" title="">
				...
				<li class="red mix penthouse">
					<a href="floorplans/plan05.pdf" target="_blank" title="">
